...
var IPython = (function (IPython) {
    ...
    var ClippyTip = function () {
            ...
            var im = $('<img/>')
            this.tooltip.append(im)
            this.im = $(im)
            this.im.attr('src','/static/custom/clippytip/clp.png')
            this.im.attr('width','128px')
            this.im.attr('style','float:left')
    ...
    ClippyTip.prototype.gen_clippy_text  = function(text, color, img){
        var color = color || 'blue'
        var imgsrc =  img || '/static/custom/clippytip/clp.png'
        this.im.attr('src',imgsrc)
        ...
        var pre = $('<div/>');
        pre.attr('style','width:350px;font-family:Comic Sans MS; padding-top:1em; font-size:1.5em; color:'+color)
        pre.text(text)
    ...
    ClippyTip.prototype.showInPager = function (cell) {
    ...
    ClippyTip.prototype.expand = function () {
    ...
    ClippyTip.prototype._hide = function () {
    ...
    ClippyTip.prototype.remove_and_cancel_tooltip = function (force) {
    ...
    ClippyTip.prototype.cancel_pending = function () {
    ...
    ClippyTip.prototype.pending = function (cell, hide_if_no_docstring) {
        var that = this;
    ...
    ClippyTip.prototype._request_tooltip = function (cell, func) {
    ...
    ClippyTip.prototype.request = function (cell, hide_if_no_docstring) {
        // request(codecell)
    ...
    ClippyTip.prototype.cancel_stick = function () {
    ...
    ClippyTip.prototype.stick = function (time) {
    ...
    ClippyTip.prototype._show = function (reply) {
